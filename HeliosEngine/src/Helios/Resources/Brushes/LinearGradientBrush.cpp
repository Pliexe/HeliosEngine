...
//	if (SUCCEEDED(DepricatedGraphics::instance->m_renderTarget2D->CreateGradientStopCollection(
//		gradientStops,
//		2,
//		D2D1_GAMMA_2_2,
...
//		DepricatedGraphics::instance->m_renderTarget2D->CreateLinearGradientBrush(
