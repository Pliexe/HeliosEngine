...
namespace Helios
{
	...
	public:
		...
		static void DrawWireCube(const TransformComponent& transform, const Vector3& scale);
		static void DrawWireQuad(const TransformComponent& transform, const Vector3& scale, float line_width = 1.0f);
