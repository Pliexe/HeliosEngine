...
namespace Helios
{
	...
	public:
		...
		uint32_t AddVertex(MeshVertex&& vertex);
		uint32_t AddVertex(Vector3 position, Vector2 texCoord, Vector3 normal);
		...
		static void CalculateVertexNormals(MeshBuilder& meshBuilder);
